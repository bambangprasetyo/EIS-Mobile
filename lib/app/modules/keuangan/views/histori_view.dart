...
class HistoriView extends GetView<KeuanganController> {
          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              ...
              child: FutureBuilder<List<Map<String, dynamic>>>(
                future: historikeuangan(selectedKPI),
...
Future<List<Map<String, dynamic>>> historikeuangan(String? selectedKPI) async {
  try {
    ...
    if (userDataBody['success'] == true) {
      ...
      var histori = HistoriKeuangan();
      var response = await histori.dataHistorikeuangan(cabang, selectedKPI!);
